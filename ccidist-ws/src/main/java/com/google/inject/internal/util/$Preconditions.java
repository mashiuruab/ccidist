 ...
 * as  -- yet the method will still throw an exception anyway,
...
/**
*
*   This Utility $Preconditions class is accessed by  QuartzModule class in package org.nnsoft.guice.guartz
*   but, latest version of sisu-guice does not provide this class as a result of ClassNotFoundException
*   is thrown by the classLoader. So this class is added here to remove that error.
*
* */
