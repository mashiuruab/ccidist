...
import org.hibernate.ejb.packaging.*;
...
public class Ejb3ConfigurationHack extends Ejb3Configuration {
    private static final long serialVersionUID = 8347474927772367278L;
     ...
     *
     * @see org.hibernate.ejb.HibernatePersistence#createEntityManagerFactory(String, java.util.Map)
     */
    @Override
    @SuppressWarnings({ "unchecked" })
        ...
        try {
            ...
            while ( xmls.hasMoreElements() ) {
                ...
                for ( PersistenceMetadata metadata : metadataFiles ) {
                    ...
                    if ( metadata.getProvider() == null || metadata.getProvider().startsWith(IMPLEMENTATION_NAME) ) {
                        //correct provider
     ...
     * In Hibernate EM, this correlates to {@link org.hibernate.ejb.HibernatePersistence#createContainerEntityManagerFactory}
     *
     ...
     * @return this
     *
     * @see org.hibernate.ejb.HibernatePersistence#createContainerEntityManagerFactory
     */
    @Override
    @SuppressWarnings({ "unchecked" })
     ...
     * <li>the {@code xmlDocuments} list with parsed/validated {@link org.hibernate.internal.util.xml.XmlDocument} corrolary to each xml file</li>
     * </ul>
     *
     ...
     * @param xmlDocuments (output) The list of {@link org.hibernate.internal.util.xml.XmlDocument} instances of each entry in {@code xmlFiles}
     */
    @SuppressWarnings({ "unchecked" })
...
//          }
     ...
     * {@link javax.persistence.spi.PersistenceProvider}/{@link org.hibernate.ejb.HibernatePersistence} contracts.
